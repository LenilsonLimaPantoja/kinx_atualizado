import styles from './PostFeedLocais.module.scss';
...
const PostFeedLocais = () => {
    return (
        <div className={styles.darkrooms_populares_agora}>
            <div className={styles.area_locais_relacionados}>
                <span>Locais relacionados em <strong>São Paulo, SP -  Brasil</strong></span>
                <div className={styles.locais_relacionados}>
                    <button>
                        <FaExpand />
                    </button>
                </div>
